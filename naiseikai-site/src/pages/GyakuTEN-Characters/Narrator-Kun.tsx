...
function Breadcrumb() {
  return (
    <nav className="flex items-center gap-2 text-xs font-mono text-text-faint mb-8 flex-wrap">
      ...
      <span>/</span>
      <span style={{ color: '#f87171' }}>Narrator-kun</span>
    </nav>
  )
}
    ...
    <div className="page-container">
      ...
      <div className="space-y-8">
        <div>
          ...
          <h2 className="font-serif text-3xl mb-1" style={{ color: '#f87171' }}>Narrator-kun</h2>
      ...
      <div className="flex justify-between items-center gap-4 flex-wrap mt-6">
        ...
        <div><Link to="/titles/GyakuTEN-ParadoxicalReincarnation/Eina-Arataki" className="btn-neon-purple text-xs">Eina Arataki →</Link></div>
      </div>
    </div>
  )
}
