        ...
        <div className="flex items-start justify-between pt-8 border-t border-[#2e2b26] mt-16">
            ...
            <div>
              ...
              <p className="font-display text-sm text-[#f2ebeb]">Databases &amp; Systems</p>
                  ...
                  <Link to="/world/databases/ThePowerscalingSystem" className="group flex items-center gap-3 px-5 py-4 rounded-xl border border-[#2e2b26] bg-[#1a1714] hover:border-[#c9a84c]/40 hover:bg-[#1f1c18] transition-all duration-200 max-w-[45%] text-right">
            <div>
              <p className="font-display text-xs text-[#4a4844] uppercase tracking-wider mb-0.5">Next</p>
              <p className="font-display text-sm text-[#f2ebeb]">The PowerScale System</p>
            </div>
            <span className="text-[#c9a84c] text-lg">→</span>
          </Link>
      </div>
