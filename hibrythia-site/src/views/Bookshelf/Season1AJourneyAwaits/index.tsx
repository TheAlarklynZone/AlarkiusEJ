...
const VOLUMES = [
  { to: "/bookshelf/season1/vol1", label: "Volume 1: A Grand Voyage", tag: "Season 1", available: true },
  { to: "/bookshelf/season1/vol2", label: "Volume 2: TBD", tag: "Season 1", available: false },
  { to: "/bookshelf/season1/vol3", label: "Volume 3: TBD", tag: "Season 1", available: false },
  { to: "/bookshelf/season1/vol4", label: "Volume 4: TBD", tag: "Season 1", available: false },
  { to: "/bookshelf/season1/vol5", label: "Volume 5: TBD", tag: "Season 1", available: false },
  { to: "/bookshelf/season1/vol6", label: "Volume 6: TBD", tag: "Season 1", available: false },
  { to: "/bookshelf/season1/vol7", label: "Volume 7: TBD", tag: "Season 1", available: false },
  { to: "/bookshelf/season1/vol8", label: "Volume 8: TBD", tag: "Season 1", available: false },
  { to: "/bookshelf/season1/vol9", label: "Volume 9: TBD", tag: "Season 1", available: false },
];

export default function Season1AJourneyAwaits() {
  return (
    <div className="max-w-[960px] mx-auto px-6 py-20 space-y-16">
      ...
      <div>
        ...
        <p className="font-body text-base text-[#c8c2ba] leading-relaxed max-w-[640px]">
          27 books across 9 volumes. The first season of The Hibrythian Saga — where the world of Hetra is introduced and adventure begins.
        </p>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {VOLUMES.map(({ to, label, tag, available }) => (
            <Link
              key={to}
              to={to}
            ...
            >
              ...
              {available && (
                <span className="font-body text-[9px] tracking-widest uppercase text-[#c9a84c] mt-1.5">
                  Available Now
                </span>
              )}
            </Link>
