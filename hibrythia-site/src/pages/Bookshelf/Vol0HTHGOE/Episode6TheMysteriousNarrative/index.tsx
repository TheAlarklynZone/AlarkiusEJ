export default function Episode6TheMysteriousNarrative() {
  return (
    <div className="max-w-[960px] mx-auto px-6 py-20">
      <div className="gold-rule mb-6" aria-hidden="true" />
      <p className="font-body text-xs tracking-[0.25em] text-[#c9a84c] uppercase mb-3">Vol. 0 · Episode 6</p>
      ...
      <div className="flex items-center justify-between gap-4 border-t border-[#2e2b26] pt-8 mt-8">
        <div><a href="/bookshelf/vol0/episode-5" className="flex items-center gap-2 font-body text-xs tracking-widest uppercase px-4 py-2.5 border border-[#2e2b26] text-[#7a7670] rounded-sm hover:border-[#c9a84c]/40 hover:text-[#d8d4cc] transition-all duration-[180ms]">← Episode 5</a></div>
