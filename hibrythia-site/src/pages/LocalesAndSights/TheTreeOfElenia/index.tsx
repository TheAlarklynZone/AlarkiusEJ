    ...
    <div className="min-h-screen bg-[#100908] py-16">
      <div className="max-w-[960px] mx-auto px-6">
        ...
        <div className="flex items-start justify-between">
          ...
          <Link to="/world/locales/oakgnar-grand-tree" className="group block p-4 border border-[#2e2b26] hover:border-[#c9a84c]/40 bg-[#0f0d0c] hover:bg-[#151210] rounded-sm transition-all duration-200 max-w-[220px] text-right">
            ...
            <p className="font-display text-base text-[#f2ebeb]">The Oakgnar Grand Tree</p>
          </Link>
        </div>
